...
<html lang="en">
    ...
    <body class="bg-zinc-950 text-zinc-100 min-h-screen">
        <div class="max-w-7xl mx-auto p-8">
            ...
            <div class="flex items-center justify-between mb-10">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-xs font-medium text-zinc-400 bg-zinc-900/40 border border-zinc-800 px-4 py-2.5 rounded-3xl flex items-center gap-2 select-none">
                    ...
                    <div
                        ...
                        class="flex items-center gap-2 bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 px-5 py-2.5 rounded-3xl cursor-pointer transition-all active:scale-95 text-red-400 font-medium text-sm"
                    >
        ...
        <script>
            ...
            // Helper for common fetch headers
            function getHeaders() {
                return {
            ...
            async function clearAllData() {
                if (confirm("Clear ALL assignments? This cannot be undone.")) {
                    try {
                        const response = await fetch('/assignments/clear-all', {
                            method: 'POST',
                            headers: getHeaders()
                        });
